<template>
  <div class="footer q-pa-md bg-footer">
    <div class="flex items-center">
      <q-icon flat dense name="apps" color="indigo-10" class="text-h5 q-mr-sm" /> 
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 col-md-3">
        ...
        <a href="#" class="link text-subtitle1 text-grey-9">Snippet 3</a>
      ...
      <div class="col-12 col-sm-6 col-md-3">
        ...
        <a href="#" class="link text-subtitle1 text-grey-9">List Your Properties</a>
        <a href="#" class="link text-subtitle1 text-grey-9">Travel Tips</a>
      </div>
      <div class="col-12 col-md-12 flex justify-center q-my-sm">
        <a href="#" class="link">
          <q-icon name="facebook" size="36px" />
        </a>
        <a href="#" class="link">
          <q-icon name="ion-logo-instagram" size="36px" />
        </a>
        <a href="#" class="link">
          <q-icon name="ion-logo-twitter" size="36px" />
        </a>
      </div>
      <div class="col-12 col-md-12 flex justify-between">
        <a href="#" class="link text-subtitle1 text-grey-9">Privacy Policy</a>
        <a href="#" class="link text-subtitle1 text-grey-9">Site Terms</a>
        <a href="#" class="link text-subtitle1 text-grey-9">Interest Based Ads</a>
      </div>
    </div>
  </div>
</template>
